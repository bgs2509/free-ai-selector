...
11. Запустить финальную проверку:
    ...
    # Должны остаться только упоминания в PRD/research (историческая справка)
    ```
...
| Документ | Путь |
|----------|------|
| **F011-B PRD** | `ai-docs/docs/prd/2026-01-15_F011-B_system-prompts-json-response-prd.md` |
| **F011-B Research** | `ai-docs/docs/research/2026-01-15_F011-B_system-prompts-json-response-research.md` |
| **CLAUDE.md** | `./CLAUDE.md` |
